 ...
 *
 * Tarea:
 *   Ejercicio 1 - ClaveInexistenteException: excepcion CHEQUEADA de la
 *   jerarquia propia. La lanzan eliminar, obtener, sucesor, predecesor y
 *   rango del ABB, y obtener/eliminar del IndiceDoble, cuando la clave no
 *   esta.
 *
 * ---------------------------------------------------------------------
