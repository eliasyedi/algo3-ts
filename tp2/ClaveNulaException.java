 ...
 *
 * Tarea:
 *   Ejercicio 1 - ClaveNulaException: excepcion NO CHEQUEADA de la
 *   jerarquia propia. Se lanza cuando la clave recibida es null: pasar
 *   null no es una situacion que el cliente pueda prever y manejar, es un
 *   error de programacion de quien llama.
 *
 * ---------------------------------------------------------------------
